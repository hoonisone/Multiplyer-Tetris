...
//#include "string+.h"
//
//static void CursorGraphicInit();
//static void CursorGraphicSetFullScreen();
//static void CursorGraphicSetScreenSize(int width, int height);
//static void CursorGraphicSetColor(Color color);
//static void CursorGraphicMove(int x, int y);
//static void CursorGraphicDrawVertical(int x, int y, int len);
//static void CursorGraphicDrawHorizontal(int x, int y, int len);
//static void CursorGraphicDrawRectangle(int x, int y, int width, int height);
//static void CursorGraphicDrawFilledRectangle(int x, int y, int width, int height);
//static void CursorGraphicSetLetter(char* letter);
//static void CursorGraphicDrawLineRectangle(int x, int y, int width, int height);
//static void CursoGraphicSetBackgroundColor(int color);
//void CursorGraphicDelete(CursorGraphic* gm);
//void CursorGraphicrPrintText(int x, int y, char* text);
//
//static char letter[LETTER_SIZE];
//
//CursorGraphic* createCursorGraphic()
//{
//	static GraphicCursorManager* object = NULL;
//	if (object == NULL) {
//		object = (GraphicCursorManager*)malloc(sizeof(GraphicCursorManager));
